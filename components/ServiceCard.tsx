  ...
  return (
    <Link
      ...
      className="
        ...
        transition-all duration-[550ms] [transition-timing-function:cubic-bezier(0.22,1,0.36,1)]
    ...
    >
      ...
      <span className="pointer-events-none absolute inset-0 z-0 overflow-hidden rounded-3xl" aria-hidden>
        <span className="block absolute inset-0 translate-y-[85%] transition-transform duration-[550ms] [transition-timing-function:cubic-bezier(0.22,1,0.36,1)] group-hover:translate-y-0 motion-reduce:translate-y-0 motion-reduce:opacity-0 motion-reduce:group-hover:opacity-100 motion-reduce:transition-opacity">
          <Image
            src={service.image}
            alt=""
            fill
      ...
      <span
        ...
        className="
          ...
          transition-opacity duration-[550ms] [transition-timing-function:cubic-bezier(0.22,1,0.36,1)]
      ...
      <div
        className="
          ...
          transition-colors duration-[550ms] [transition-timing-function:cubic-bezier(0.22,1,0.36,1)]
        "
      >
        ...
        <span
          className="
            ...
            transition-colors duration-[550ms]
