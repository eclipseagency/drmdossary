        ...
        {isOpen && (
          ...
          >
            <div className="flex items-stretch justify-end gap-3 sm:gap-3.5">
              {/* Doctor avatar (decorative) */}
              <span
                aria-hidden
                className="hidden sm:flex h-10 w-10 shrink-0 items-center justify-center self-end rounded-full bg-gradient-brand-soft text-white shadow-glow ring-2 ring-white"
